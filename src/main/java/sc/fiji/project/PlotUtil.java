...
class PlotUtil {
	...
	static void displayHistogram(double[] values, String series, String title, String xLabel, String yLabel, int bins) {
	...
	static double[] toDoubleArray(List<Object> column) {
